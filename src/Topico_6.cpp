...
int main() {
    ...
    imwrite("/home/matheus/Dropbox/treinamento-pdi/results/6_lena_colored.jpg", image);
    imwrite("/home/matheus/Dropbox/treinamento-pdi/results/6_lena_gray_scale.jpg", grayImage);
    imwrite("/home/matheus/Dropbox/treinamento-pdi/results/6_lena_canny_filter.jpg", cannyFilter);
