...
int main() {
    ...
    imwrite("/home/matheus/Dropbox/treinamento-pdi/results/3_baboon_red_channel.jpg", channels[0]);
    imwrite("/home/matheus/Dropbox/treinamento-pdi/results/3_baboon_green_channel.jpg", channels[1]);
    imwrite("/home/matheus/Dropbox/treinamento-pdi/results/3_baboon_blue_channel.jpg", channels[2]);
