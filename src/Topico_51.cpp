...
int main() {
    ...
    detectorSIFT.detect(img1, vecKeyPoint1);
    detectorSIFT.detect(img2, vecKeyPoint2);
    ...
    imwrite("/home/bolsista/Documents/treinamento-pdi/results/51_sift_detection.jpg", result);
