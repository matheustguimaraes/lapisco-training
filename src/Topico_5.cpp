...
int main() {
    ...
    imwrite("../results/baboon.jpg", image);
    imwrite("../results/5_baboon_gray_scale.jpg", grayImage);
    imwrite("../results/5_baboon_median_filter.jpg", medianImage);
    imwrite("../results/5_baboon_mean_filter.jpg", meanImage);
